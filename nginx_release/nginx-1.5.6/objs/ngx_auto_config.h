#define NGX_CONFIGURE " --prefix=/usr/local/nginx_helloworld --add-module=/data/haoning/mygit/mynginxmodule/mynginx/hello_world --with-debug"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/nginx_helloworld/"
#endif
