#define NGX_CONFIGURE " --prefix=/usr/local/nginx_upstream --add-module=/data/haoning/mygit/mynginxmodule/mynginx/echo --add-module=/data/haoning/mygit/mynginxmodule/nginx_release/nginx-1.5.6/mymodule/chapter5/upstream --with-debug"
